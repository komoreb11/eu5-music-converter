...
$Tracks = @(
    # Base game
    ,@("MusicPlayer_eu4_maintheme","maintheme.ogg",$null)
    ,@("MusicPlayer_eu4_dehominisdignitate","dehominisdignitate.ogg",$null)
    ,@("MusicPlayer_eu4_kingscourt","kingscourt.ogg",$null)
    ,@("MusicPlayer_eu4_kingsinthenorth","kingsinthenorth.ogg",$null)
    ,@("MusicPlayer_eu4_machiavelli","machiavelli.ogg",$null)
    ,@("MusicPlayer_eu4_nighttime","nighttime.ogg",$null)
    ,@("MusicPlayer_eu4_thestonemasons","thestonemasons.ogg",$null)
    ,@("MusicPlayer_eu4_moodevent_thesnowiscoming","moodevent_thesnowiscoming.ogg",$null)
    ,@("MusicPlayer_eu4_amongthepoor","amongthepoor.ogg",$null)
    ,@("MusicPlayer_eu4_commerceinthepeninsula","commerceinthepeninsula.ogg",$null)
    ,@("MusicPlayer_eu4_eire","eire.ogg",$null)
    ,@("MusicPlayer_eu4_inthestreets","inthestreets.ogg",$null)
    ,@("MusicPlayer_eu4_mood_landinsight","mood_landinsight.ogg",$null)
    ,@("MusicPlayer_eu4_openseas","openseas.ogg",$null)
    ,@("MusicPlayer_eu4_thesoundofsummer","thesoundofsummer.ogg",$null)
    ,@("MusicPlayer_eu4_battleoflepanto","battleoflepanto.ogg",$null)
    ,@("MusicPlayer_eu4_event_war_battleofbreitenfeld","event_war_battleofbreitenfeld.ogg",$null)
    ,@("MusicPlayer_eu4_mykingdom","mykingdom.ogg",$null)
    ,@("MusicPlayer_eu4_rideforthvictoriously","rideforthvictoriously.ogg",$null)
    ,@("MusicPlayer_eu4_thestageisset","thestageisset.ogg",$null)
    ,@("MusicPlayer_eu4_war_offtowar","war_offtowar.ogg",$null)
    ,@("MusicPlayer_eu4_mood_discovery","mood_discovery.ogg",$null)
    ,@("MusicPlayer_eu4_theageofdiscovery","theageofdiscovery.ogg",$null)
    # DLC 013
...
if ($eu4Path -and $ffmpeg -and $wwiseConsole) {
    ...
    if ($missing.Count -eq 0) {
        ...
        foreach ($track in $missing) {
            $eventName = $track[0]; $srcOgg = $track[1]; $dlcDir = $track[2]
            $wemId   = Get-WemId $eventName
            $wemPath = "$MediaDir\$wemId.wem"
